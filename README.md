...
###Problema (dor) que o produto resolve (2–4 linhas): [Descreva o problema principal que seu
produto busca solucionar para o usuário ou para o negócio.]

### Público-alvo (quem é o usuário e contexto de uso): [Descreva o perfil do usuário principal,
suas características demográficas/comportamentais e o contexto em que ele usaria o produto.]

### Objetivo do usuário (o que ele quer alcançar): [Qual é a principal meta ou necessidade que o
usuário deseja satisfazer ao usar seu produto?]
